...
export default function LeadsHub() {
  ...
  const handleSendMessage = (e) => {
    ...
    handleLogActivity(
      activeMessage._id,
      "Email",
      `Intelligence Brief: ${msgText.substring(0, 30)}...`,
    );
  ...
  const handleEndCall = () => {
    handleLogActivity(
      activeCall._id,
      "Call",
      `Outbound: ${Math.floor(callTimer / 60)}m Session`,
    );
  ...
  if (loading)
    return (
      <div style={{ color: "white", padding: "15px" }}>Accessing Vault...</div>
    );
    ...
    <div className="animate-fade" style={{ padding: "0 10px" }}>
      ...
      >
        <div>
          ...
          <p style={{ color: "var(--text-secondary)", fontSize: 12 }}>
            Manage and track your industrial sales pipeline
          </p>
        </div>
      ...
      {filteredLeads.length === 0 ? (
        ...
        >
          ...
          >
            Your intelligence repository is empty. Add a lead manually or run
              ...
              >
                ...
                >
                  ...
                  <span
                    style={{
                      fontSize: 11,
                      fontWeight: 900,
                      color: lead.aiScore > 70 ? "#059669" : "#d97706",
                    }}
                  >
                    AI {lead.aiScore}%
                  </span>
                ...
                >
                  ...
                  <button
                    ...
                    onClick={() => navigate("/meetings", { state: { lead } })}
                  >
                    <Calendar size={14} />
                  </button>
                  <button
      ...
      {activeCall && (
        ...
        >
          <div
            ...
            style={{ width: 280, padding: "2rem 1.5rem", textAlign: "center" }}
          >
            <div
              style={{
                width: 60,
            ...
            >
              {initials(activeCall.firstName, activeCall.lastName)}
            </div>
            ...
            >
              {pad(Math.floor(callTimer / 60))}:{pad(callTimer % 60)}
            </div>
            <button
              className="btn"
              style={{
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {initials(activeMessage.firstName, activeMessage.lastName)}
              </div>
              <div>
              ...
              <div className="input-group">
                ...
                >
                  {Object.keys(STATUS_COLORS).map((s) => (
                    <option key={s} style={{ color: "black" }}>
                      {s}
                    </option>
                  ))}
                </select>
