...
const ToggleSwitch = ({ checked, onChange }) => (
  <div
    ...
    style={{
      ...
      borderRadius: 20,
      cursor: "pointer",
      background: checked ? "#10b981" : "var(--bg-primary)",
      border: `1px solid ${checked ? "#10b981" : "var(--border-color)"}`,
      position: "relative",
      transition: "all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",
      boxShadow: checked ? "0 0 10px rgba(16, 185, 129, 0.2)" : "none",
    }}
  >
    <div
      style={{
...
export default function Settings() {
  ...
  const handlePasswordChange = async (e) => {
    ...
    try {
      ...
      showToast(
        err.response?.data?.message || "Password update error",
        "error",
      );
    } finally {
    ...
    <div className="animate-fade" style={{ padding: "0 10px" }}>
      <div style={{ marginBottom: "2rem" }}>
        ...
        <p style={{ color: "var(--text-secondary)", fontSize: 12 }}>
          Advanced Environment Configuration & Security Hub
        </p>
      </div>
      ...
      <div style={cardStyle}>
        ...
        >
          ...
          <button
            className="btn btn-primary"
            style={{ fontSize: "0.75rem", padding: "6px 12px" }}
            onClick={() => showToast("Preferences Synchronized!")}
          >
            SYNC PREFERENCES
          </button>
        </div>
        ...
        >
          {[
            {
              key: "newLeads",
              title: "Real-time Lead Ingestion",
              desc: "Receive immediate pings when new structural lead data enters the pipeline.",
              icon: <Users size={14} />,
            },
            {
              key: "dealStatus",
              title: "Pipeline Status Sync",
              desc: "Get notified as leads move through industrial qualified stages.",
              icon: <Save size={14} />,
            },
            {
              key: "weeklyReport",
              title: "Industrial Performance Audit",
              desc: "Receive comprehensive weekly analytics and performance metrics via email.",
              icon: <AlertTriangle size={14} />,
            },
            {
              key: "aiScore",
              title: "AI Intelligence Alerts",
              desc: "Get notified when AI lead scoring detects high-value target anomalies.",
              icon: <Save size={14} />,
            },
            ...
            >
              ...
              <ToggleSwitch
                checked={notifs[key]}
                onChange={() => setNotifs({ ...notifs, [key]: !notifs[key] })}
              />
            </div>
          ))}
        </div>
      ...
      <div style={{ ...cardStyle, borderColor: "rgba(239, 68, 68, 0.3)" }}>
        ...
        >
          ...
          <span
            style={{ fontWeight: 700, fontSize: "0.9rem", color: "#ef4444" }}
          >
            DANGER ZONE
          </span>
        </div>
      ...
      {showDeleteConfirm && (
        ...
        >
          <div
            ...
            style={{ width: 350, padding: "2rem", textAlign: "center" }}
          >
            <AlertTriangle
              size={40}
              color="#ef4444"
            ...
            >
              Records cannot be recovered after termination.
            </p>
