...
const Activities = () => {
  ...
  const getIcon = (type) => {
    switch (type) {
      ...
      case "Call":
        return <Phone size={18} color="#4ade80" />;
      case "Meeting":
        return <Calendar size={18} color="#f59e0b" />;
      default:
        return <StickyNote size={18} color="#94a3b8" />;
    }
  };
  ...
  const filteredActivities = activities.filter((act) => {
    ...
    const searchStr =
      `${act.type} ${act.description} ${act.lead?.firstName} ${act.lead?.lastName}`.toLowerCase();
  ...
  return (
    <div
      className="activities-container animate-fade"
      style={{ padding: "10px" }}
    >
      <div
        style={{
      ...
      >
        <div>
          ...
          <p style={{ color: "var(--text-secondary)" }}>
            Real-time audit and historical intelligence tracking
          </p>
        </div>
            ...
            {["All", "Call", "Email", "Meeting"].map((type) => (
              <button
                ...
                style={{
                  ...
                  border: "none",
                  background:
                    filter === type ? "var(--accent-primary)" : "transparent",
      ...
      {filteredActivities.length === 0 ? (
        ...
        >
          ...
          />
          <p style={{ color: "var(--text-secondary)" }}>
            No matching activities found for this query.
          </p>
        </div>
      ) : (
        <div
